...
import {DynamicNFT} from "../src/dynmicNFT.sol";

contract testdyanmic is Test {
    DynamicNFT dynamicNFT;

    string private sadImgUri;
    string private happyImgUri;
    address rohan = makeAddr("alice");
    ...
    function setUp() public {
        ...
        dynamicNFT = new DynamicNFT(sadImgUri, happyImgUri);
    }
